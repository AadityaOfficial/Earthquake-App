    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                JSONObject allFeatures = features.getJSONObject(i);
                JSONObject properties = allFeatures.getJSONObject("properties");
                // Calculating Date from the millisecond time
                Earthquake data = new Earthquake(properties.getDouble("mag"), properties.getString("place"), properties.getLong("time"),properties.getString("url"));
